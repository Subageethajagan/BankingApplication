...
//     fetch(`https://firestore.googleapis.com/v1/projects/bankingapp-41d2b/databases/(default)/documents/Account`)
//       .then(response => {
//         if (!response.ok) {
...
//         return fetch(`https://firestore.googleapis.com/v1/projects/bankingapp-41d2b/databases/(default)/documents/Account/${docId}`, {
//           method: 'PATCH',
//           headers: {
...
//       return fetch(`https://firestore.googleapis.com/v1/projects/bankingapp-41d2b/databases/(default)/documents/Transactions`, {
//         method: 'POST',
//         headers: {
//           'Content-Type': 'application/json'
//         },
