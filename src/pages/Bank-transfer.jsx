...
import '../Styles/banktransfer.css'; // Import CSS file for admin page styles
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      if (parseFloat(amount) > 0) {
        ...
        const senderAccountResponse = await fetch(`https://firestore.googleapis.com/v1/projects/bankingapp-41d2b/databases/(default)/documents/Account`);
        ...
        if (senderNewBalance >= 0) {
          ...
          await fetch(`https://firestore.googleapis.com/v1/projects/bankingapp-41d2b/databases/(default)/documents/Transactions`, {
            method: 'POST',
            headers: {
              'Content-Type': 'application/json'
            },
    ...
    <div>
      <div className='background-container'>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button type="submit" className="submit-buttonBankTransfer" disabled={transactionInProgress}>
