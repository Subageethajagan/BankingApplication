...
//     try {
//       const response = await axios.get('https://firestore.googleapis.com/v1/projects/bankingapp-41d2b/databases/(default)/documents/Loan');
...
//           const accountsResponse = await axios.get('https://firestore.googleapis.com/v1/projects/bankingapp-41d2b/databases/(default)/documents/customerAccounts');
//           const accounts = accountsResponse.data.documents;
 
//           const accountResponse = await axios.get('https://firestore.googleapis.com/v1/projects/bankingapp-41d2b/databases/(default)/documents/Account');
...
//             await axios.patch(`https://firestore.googleapis.com/v1/projects/bankingapp-41d2b/databases/(default)/documents/customerAccounts/${accountToUpdate.name.split('/').pop()}`, {
//               fields: {
...
//             await axios.patch(`https://firestore.googleapis.com/v1/projects/bankingapp-41d2b/databases/(default)/documents/Account/${accToUpdate.name.split('/').pop()}`, {
//               fields: {
...
//       await axios.patch(`https://firestore.googleapis.com/v1/projects/bankingapp-41d2b/databases/(default)/documents/Loan/${id}`, {
//         fields: {
  ...
  return (
    ...
    <div className="loan-details-container">
      ...
      {pendingRequests.length === 0 ? (
        ...
        <ul>
          {pendingRequests.map(request => (
            <li key={request.id}  className="loan-details-item">
              <div style={{ marginBottom: '10px' }}>
                <strong>Account Number:</strong> {request.fields.accountNumber.integerValue}
              </div>
              <div style={{ marginBottom: '10px' }}>
